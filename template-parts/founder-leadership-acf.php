...
/* Quote Icon in opposite (opening) direction */
#ci360-founder-profiles-section .fnd-quote-icon {
    width: 20px;
    height: 20px;
    flex-shrink: 0;
      ...
      <div class="lg:col-span-7 space-y-6 text-left">
        ...
        <div class="fnd-quote-box space-y-3">
          <div class="flex items-center gap-2 text-cyan-400">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 fnd-quote-icon rotate-180">
